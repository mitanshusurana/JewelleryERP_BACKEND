...
## Table of Contents
1.  [Core Principles & Architecture](#1-core-principles--architecture)
2.  [Microservice Deep Dive](#2-microservice-deep-dive)
3.  [Technology Stack & Rationale](#3-technology-stack--rationale)
4.  [API Design & Communication Protocol](#4-api-design--communication-protocol)
...
![Microservices Architecture Diagram](https://i.imgur.com/8d5t4gS.png)
...
- **CI/CD:** GitHub Actions will be used. A typical pipeline will consist of:
    1.  **On Pull Request:** Build -> Run Unit & Integration Tests.
    2.  **On Merge to `main`:** Build Docker Image -> Push to Registry (e.g., Docker Hub, ECR) -> Deploy to Staging Environment.
    3.  **On Git Tag:** Promote build from Staging to Production.
